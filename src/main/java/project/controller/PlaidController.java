...
public class PlaidController {
    ...
    @PostMapping("/sandbox/create-public-token")
    public ResponseEntity<?> createSandboxPublicToken(Authentication authentication) {
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(new ErrorResponse("Error creating sandbox public token: " + e.getMessage()));
        }
    }
}
